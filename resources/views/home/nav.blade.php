<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#julian-jordan-navigation" aria-expanded="false">
            ...
            <a class="navbar-brand" href="#">
                <img alt="Brand" class="img-responsive logo" src="img/julian-jordan-logo.png">
            </a>
        </div>
        <div class="collapse navbar-collapse" id="julian-jordan-navigation">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="socials" target="_blank" href="https://soundcloud.com/julianjordan"><i class="fa fa-soundcloud"></i></a></li>
            </ul>
        </div>
    </div>
</nav>
